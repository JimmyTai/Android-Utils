...
public class HoloCircularProgressBar extends View {
    ...
    public HoloCircularProgressBar(final Context context, final AttributeSet attrs) {
        this(context, attrs, com.jimmytai.library.utils.R.attr.circularProgressBarStyle);
    }
    ...
    public HoloCircularProgressBar(final Context context, final AttributeSet attrs,
        ...
        final TypedArray attributes = context
                .obtainStyledAttributes(attrs, com.jimmytai.library.utils.R.styleable.HoloCircularProgressBar,
                        defStyle, 0);
        if (attributes != null) {
            try {
                setProgressColor(attributes
                        .getColor(com.jimmytai.library.utils.R.styleable.HoloCircularProgressBar_progress_color, Color.CYAN));
                setProgressBackgroundColor(attributes
                        .getColor(com.jimmytai.library.utils.R.styleable.HoloCircularProgressBar_progress_background_color,
                                Color.GREEN));
                setProgress(
                        attributes.getFloat(com.jimmytai.library.utils.R.styleable.HoloCircularProgressBar_progress, 0.0f));
                setMarkerProgress(
                        attributes.getFloat(com.jimmytai.library.utils.R.styleable.HoloCircularProgressBar_marker_progress,
                                0.0f));
                setWheelSize((int) attributes
                        .getDimension(com.jimmytai.library.utils.R.styleable.HoloCircularProgressBar_stroke_width, 10));
                setThumbEnabled(attributes
                        .getBoolean(com.jimmytai.library.utils.R.styleable.HoloCircularProgressBar_thumb_visible, true));
                setMarkerEnabled(attributes
                        .getBoolean(com.jimmytai.library.utils.R.styleable.HoloCircularProgressBar_marker_visible, true));

                mGravity = attributes
                        .getInt(com.jimmytai.library.utils.R.styleable.HoloCircularProgressBar_android_gravity,
                                Gravity.CENTER);
            } finally {
    ...
    /**
     * gives the current progress of the ProgressBar. Value between 0..1 if you set the progress over 1 you'll get progress % 1 as return
     * value
     *
     * @return the progress
     */
